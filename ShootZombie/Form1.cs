    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonPress(object sender, KeyEventArgs e)
        {
            ...
            if (hp == 0)
            {
                timer.Stop();
                minus.Visible = false;
                MessageBox.Show("GAME OVER! 沒血啦!" + Environment.NewLine + "再多練習看看吧!"+ Environment.NewLine + 
                    "一共消滅了 " + count + " 個敵人" + Environment.NewLine + "你的得分是 " + score + " 分");
                this.Close();
            }
        }
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            if (timeLeft > 0)
            {
                ...
                {
                    timer.Stop();
                    MessageBox.Show("大獲全勝!" + Environment.NewLine + "你已經消滅所有敵人" + Environment.NewLine +
                    "一共消滅了 " + count + " 個敵人" + Environment.NewLine + "你的得分是 " + score + " 分");
                    this.Close();
                }
            }
            else
            {
                timer.Stop();
                minus.Visible = false;
                MessageBox.Show("時間到!" + Environment.NewLine + 
                    "一共消滅了 " + count + " 個敵人" + Environment.NewLine + "你的得分是 " + score + " 分");
                this.Close();
            }
        }
